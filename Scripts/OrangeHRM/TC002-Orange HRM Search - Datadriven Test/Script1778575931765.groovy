...
WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Username'), LoginUser)

WebUI.setEncryptedText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Password'), LoginPassword)
