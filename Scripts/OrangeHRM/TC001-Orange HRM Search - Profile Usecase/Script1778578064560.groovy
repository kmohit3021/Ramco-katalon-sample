...
WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Username'), GlobalVariable.G_USR)

WebUI.setEncryptedText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Password'), GlobalVariable.G_PWD)
