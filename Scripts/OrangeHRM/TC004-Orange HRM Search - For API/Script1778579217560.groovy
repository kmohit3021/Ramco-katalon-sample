...
WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Username'), GlobalVariable.G_ACCESS_TOKEN)

WebUI.comment(GlobalVariable.G_CurePassword)

WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Password'), GlobalVariable.G_REFRESH_TOKEN)
